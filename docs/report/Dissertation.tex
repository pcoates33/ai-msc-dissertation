...
\title{\bf Using an Energy-Based Model to provide\\
            rewards to a Reinforcement Learning agent\\
                for the control of a robot arm.}
\author{Peter Coates}
\date{MSc inArtificial Intelligence\\ 
...
You will wish to cite authors like \citep{2023_ElgueaAguinaco} or \citep{2021_Lobbezoo}. Alternate
commands are used to cite \citet{2023_ElgueaAguinaco} as a noun, or add text to the citation, \citep[\emph{e.g.},][]{2021_Lobbezoo}.

Try another citation with cite \cite{2018_Fu}
And another with citep \citep{2020_Du}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\bibliography{ai_msc_dissertation_bib}
